...
parser = argparse.ArgumentParser(description='Solves the following Lab: Insufficient workflow validation')
...
# PUT JACKET INSIDE CART AND ORDER SKIPPING CHECKOUT
